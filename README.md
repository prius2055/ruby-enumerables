...
**[Ruby-enumerables]()** is a project that enables the creation of enumerables using classes, modules, instant variables and methods.
...
- [ ] **[Creation of enumerables using classes]**
- [ ] **[creation of enumerables using modules]**
